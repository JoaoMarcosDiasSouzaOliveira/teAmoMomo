...
<body>  
    ...
    <div id="imagem-container">
        <div class="image-container">
            ...
            <a href='<?php echo e(route('txt1')); ?>'> Amei muito essa foto amor </a>
        </div>
        <div class="image-container">
            <img src="/images/foto4.jpeg">
            <a href='<?php echo e(route('txt2')); ?>'> Uma das minha fotos favoritas </a>
        </div>
        <div class="image-container">
            <img src="/images/foto2.jpeg">
            <a href='<?php echo e(route('txt3')); ?>'> Te amo muito muitãooo💕💕 </a>
        </div>
        <div class="image-container">
            <img src="/images/foto3.jpeg">
            <a href='<?php echo e(route('txt4')); ?>'> Búzios né😜 </a>
        </div>
        <div class="image-container">
            <img src="/images/foto5.jpeg">
            <a href='<?php echo e(route('txt5')); ?>'> ❤️❤️❤️❤️ </a>
        </div>
        <div class="image-container">
            <img src="/images/foto8.jpeg">
            <a href='<?php echo e(route('txt6')); ?>'> Amo essa foto também </a>
        </div>
        <div class="image-container">
            <img src="/images/foto7.jpeg">
            <a href='<?php echo e(route('txt7')); ?>'> Nossa primeira foto juntos </a>
        </div>
        <div class="image-container">
            <img id="filha-da-puta" src="/images/foto11.jpeg">
            <a href='<?php echo e(route('txt8')); ?>'> Sua cara = 😒 </a>
        </div>
        <div class="image-container">
            <img src="/images/foto9.jpeg">
            <a href='<?php echo e(route('txt9')); ?>'> Primeiro porre de momo kkk </a>
        </div>
        <div class="image-container">
            <img src="/images/foto12.jpeg">
            <a href='<?php echo e(route('txt10')); ?>'> KKKKK amo suas caretas </a>
        </div>
        <div class="image-container">
            <img src="/images/foto10.jpeg">
            <a href='<?php echo e(route('txt11')); ?>'> Primeira vez que dormimos "juntos" </a>
        </div>
        <div class="image-container">
            <img src="/images/foto6.jpeg">
            <a href='<?php echo e(route('txt12')); ?>'> Minha fotoca favorita sua</a>
        </div>
    </div>

</body>
</html><?php /**PATH C:\Momo\te-amo\resources\views/fotocas.blade.php ENDPATH**/ ?>